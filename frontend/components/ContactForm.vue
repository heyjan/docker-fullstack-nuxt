    ...
    >
      <div class="flex flex-col justify-between">
        <div>
          ...
          <div class="text-gray-700 mt-8">
            Du magst keine Kontaktformulare? Sende mir eine
            <a href="mailto:jan@heyjan.de"
      ...
      <div class="">
        ...
        <div class="mt-8">
          <button
            :disabled="isDisabled"
            class="disabled:opacity-25 disabled:cursor-not-allowed uppercase text-sm font-bold tracking-wide bg-indigo-500 text-gray-100 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline"
          >
            Send Message
          </button>
          <p class="mt-8">
            <label for="terms">
              <input id="terms" v-model="terms" type="checkbox" /> Ich stimme
